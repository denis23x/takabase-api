...
export default async function (fastify: FastifyInstance): Promise<void> {
  fastify.route({
    ...
    handler: async function (request: FastifyRequest<PostPrivateUpdateDto>, reply: FastifyReply): Promise<any> {
            ...
            if (Object.keys(postPrivateStorageHandler).length) {
              ...
              if (postPrivateImage) {
                ...
                if (!postPrivateImageStorage) {
                  ...
                  request.body.image = request.server.markdownPlugin.getImageListRewrite(postPrivateImage, updatedTempImageList, updatedPostImageList);
